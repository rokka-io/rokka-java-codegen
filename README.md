...
```groovy
compile "io.rokka.client.codegen:rokka-client-codegen:0.0.2"
```
...
* target/rokka-client-codegen-0.0.2.jar
* target/lib/*.jar
...
```
java -cp target/lib/*:target/rokka-client-codegen-0.0.2.jar io.rokka.examples.ListStacks
```
