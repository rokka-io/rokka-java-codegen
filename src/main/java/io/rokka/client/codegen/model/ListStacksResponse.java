...
public class ListStacksResponse {
  ...
  private List<Stack> items = null;

  public ListStacksResponse items(List<Stack> items) {
    this.items = items;
    return this;
  }

  public ListStacksResponse addItemsItem(Stack itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<Stack>();
    }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.items, listStacksResponse.items);
  }
